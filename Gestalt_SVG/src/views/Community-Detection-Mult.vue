<template>
    <div class="hull-select">
        <v-switch v-model="subsubgroupHull" inset color="#9ecae1" class="switch" label="a" />
        <v-switch v-model="subgroupHull" inset color="#ff9896" class="switch" label="b" />
        <v-switch v-model="groupHull" inset color="#FFC000" class="switch" label="c" />
    </div>
