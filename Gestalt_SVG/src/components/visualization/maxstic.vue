...
// 数据源URL
const NORMAL_DATA_URL = "http://192.168.107.209:5000/normalized_init_json";
const INIT_DATA_URL = "http://192.168.107.209:5000/cluster_features";
const MAPPING_DATA_URL = "http://192.168.107.209:5000/average_equivalent_mapping";
const EQUIVALENT_WEIGHTS_URL = "http://192.168.107.209:5000/equivalent_weights_by_tag"; // 新的数据源
...
async function fitGMM(data) {
    try {
        ...
        // 调用后端API计算GMM
        const response = await fetch('http://192.168.107.209:5000/calculate_gmm', {
            method: 'POST',
            headers: {
