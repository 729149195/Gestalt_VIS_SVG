...
const height = 700;
const svg = ref(null);
const apiUrl = 'http://192.168.107.209:5000/community_data_mult';
const runClusteringUrl = 'http://192.168.107.209:5000/run_clustering';
const epsUrl = 'http://192.168.107.209:5000/get_eps_list';
