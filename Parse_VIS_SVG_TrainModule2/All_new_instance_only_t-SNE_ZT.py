...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', default='./DataProduce/UpdatedStepGroups_mds_211_train40_v2', type=str, help='数据集目录')
    ...
    parser.add_argument('--model_path', default='save/model_mds_211_v2', type=str, help='模型保存路径')
