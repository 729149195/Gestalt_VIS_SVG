...
# 定义目录路径
questionnaire_dir = './DataProduce/Test_QuestionnaireData'
features_dir = 'Questionnaire_normal_features_linerposition_mds_5'
step_groups_dir = './DataProduce/StepGroups_5'
output_dir = './DataProduce/UpdatedStepGroups_5'
